...
is a script to make/update the `corpus_conversion.json` file to support batch convertion.
This is a similar routine to the one we ahve used previously at:
`https://github.com/OpenScore/Lieder/blob/main/README.md`
and the same notes as there apply here.
"""
